...
import { Video, Plus, ArrowRight, ShieldCheck, MessageSquare, FolderOpen, Clock3, LogOut, Copy, ExternalLink, RefreshCw } from 'lucide-react';
...
export default function DashboardPage() {
  ...
  const create=async()=>{
    ...
    try{
      ...
      const meeting=r.data?.data as Meeting | undefined;
      setShowCreate(false);
      setTitle('');
      if(meeting?.code){
